...
public class WristConstants {
  ...
  public static final double MAX_POSITION = 0.465;
  ...
  public static final WristConfig WRIST_CONFIG =
      switch (Constants.getRobot()) {
        case COMP_BOT_2025 -> new WristConfig(6, 0.137, false, true);
  ...
  public static final ArmFeedForwardConstants FEEDFORWARD =
      switch (Constants.getRobot()) {
        case COMP_BOT_2025 -> new ArmFeedForwardConstants(0.0, 1.43, 0.0, 0.0);
