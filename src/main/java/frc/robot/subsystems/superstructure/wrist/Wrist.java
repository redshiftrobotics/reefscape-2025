...
public class Wrist extends SubsystemBase {
  ...
  public void goTo(double setpoint) {
    // TODO: Nitpick: I prefer to call this something like setGoalRotations(rotations) or
    // setGoalPosition(degrees)
  ...
  public double getPosition() {
    // Nitpick again: I would call this something like get measured position or something like that,
    // not important though just me
